...
class RoleSeeder extends Seeder
{
    public function run(): void
    {
        $roles = [
            ...
            ['name' => UserRole::Waiter->value,     'label' => 'جرسون',        'is_system' => true, 'display_order' => 5],
            ['name' => UserRole::Chef->value,       'label' => 'المطبخ',       'is_system' => true, 'display_order' => 6],
            ['name' => UserRole::Bartender->value,  'label' => 'البار',        'is_system' => true, 'display_order' => 7],
            ['name' => UserRole::Cashier->value,    'label' => 'كاشير',        'is_system' => true, 'display_order' => 8],
        ];
