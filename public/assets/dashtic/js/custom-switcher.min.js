...
function switcherClick() {
    ...
    let backgroundColor1Var = bgDefaultColor1Btn.addEventListener('click', () => {
        ...
        localStorage.setItem('bodylightRGB', `${20 + 14} ,${30 + 14} ,${96 + 14}`);
        ...
        localStorage.setItem("dashticMenu","dark");
        localStorage.setItem("dashticHeader","dark");
    })
    let backgroundColor2Var = bgDefaultColor2Btn.addEventListener('click', () => {
        localStorage.setItem('bodyBgRGB', "8, 78, 115");
        localStorage.setItem('bodylightRGB', `${8 + 14} ,${78 + 14} ,${115 + 14}`);
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'dark');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
    ...
    let backgroundColor3Var = bgDefaultColor3Btn.addEventListener('click', () => {
        ...
        localStorage.setItem('bodylightRGB', `${90 + 14} ,${37 + 14} ,${135 + 14}`);
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'dark');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
    ...
    let backgroundColor4Var = bgDefaultColor4Btn.addEventListener('click', () => {
        ...
        localStorage.setItem('bodylightRGB', `${24 + 14} ,${101 + 14} ,${51 + 14}`);
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'dark');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
    ...
    let backgroundColor5Var = bgDefaultColor5Btn.addEventListener('click', () => {
        ...
        localStorage.setItem('bodylightRGB', `${120 + 14} ,${66 + 14} ,${20 + 14}`);
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'dark');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
    ...
    let lightThemeVar = lightBtn.addEventListener('click', () => {
        lightFn();
        localStorage.setItem("dashticHeader", 'light');
        localStorage.setItem("dashticMenu", 'light');
        localStorage.removeItem("bodylightRGB");
        localStorage.removeItem("bodyBgRGB");
        localStorage.removeItem("dashticMenu");
    })
    /* Light Layout End */
    ...
    let colorMenuVar = colorMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dashticMenu", 'color');
    });
    /* Color Menu End */
    ...
    let gradientMenuVar = gradientMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dashticMenu", 'gradient');
    });
    /* Gradient Menu End */
    ...
    let transparentMenuVar = transparentMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dashticMenu", 'transparent');
    });
    ...
    let colorHeaderVar = colorHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dashticHeader", 'color');
    });
    /* Color Header End */
    ...
    let gradientHeaderVar = gradientHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dashticHeader", 'gradient');
    });
    /* Gradient Header End */
    ...
    let transparentHeaderVar = transparentHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dashticHeader", 'transparent');
    });
    ...
    let fullwidthVar = fullwidthBtn.addEventListener('click', () => {
        ...
        localStorage.removeItem("dashticboxed");
    });
    ...
    let boxedVar = boxedBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dashticboxed", true);
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("dashticregular", true);
        localStorage.removeItem("dashticclassic");
    });
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("dashticclassic", true);
        localStorage.removeItem("dashticregular");
    });
    ...
    let fixedHeaderVar = fixedHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dashticheaderfixed", true);
        localStorage.removeItem("dashticheaderscrollable");
    });

    let scrollHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-position', 'scrollable');
        localStorage.setItem("dashticheaderscrollable", true);
        localStorage.removeItem("dashticheaderfixed");
    });
    ...
    let fixedMenuVar = fixedMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dashticmenufixed", true);
        localStorage.removeItem("dashticmenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn.addEventListener('click', () => {
        html.setAttribute('data-menu-position', 'scrollable');
        localStorage.setItem("dashticmenuscrollable", true);
        localStorage.removeItem("dashticmenufixed");
    });
    ...
    let closedVar = closedBtn.addEventListener('click', () => {
        closedSidemenuFn();
        localStorage.setItem("dashticverticalstyles", 'closed');
    });
    /* Closed Sidemenu End */
    ...
    let detachedVar = detachedBtn.addEventListener('click', () => {
        detachedFn();
        localStorage.setItem("dashticverticalstyles", 'detached');
    });
    /* Hover Submenu End */
    ...
    let iconTextVar = iconTextBtn.addEventListener('click', () => {
        iconTextFn();
        localStorage.setItem("dashticverticalstyles", 'icontext');
    });
    ...
    let overlayVar = overlayBtn.addEventListener('click', () => {
        iconOverayFn();
        localStorage.setItem("dashticverticalstyles", 'overlay');
    });
    ...
    let doubleVar = doubleBtn.addEventListener('click', () => {
        doubletFn();
        localStorage.setItem("dashticverticalstyles", 'doublemenu');
    });
    ...
    let menuClickVar = menuClickBtn.addEventListener('click', () => {
        ...
        menuClickFn();
        localStorage.setItem("dashticnavstyles", 'menu-click');
        localStorage.removeItem("dashticverticalstyles");
    ...
    let iconClickVar = iconClickBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconClickFn();
        localStorage.setItem("dashticnavstyles", 'icon-click');
        localStorage.removeItem("dashticverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconHoverFn();
        localStorage.setItem("dashticnavstyles", 'icon-hover');
        localStorage.removeItem("dashticverticalstyles");
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("dashticlayout");
        localStorage.setItem("dashticverticalstyles", 'default');
        verticalFn();
        setNavActive();
...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", "/assets/dashtic/libs/bootstrap/css/bootstrap.min.css");
    }
...
function lightFn() {
    ...
    updateColors()
    localStorage.removeItem("dashticdarktheme");
    localStorage.removeItem("dashticbgColor");
    localStorage.removeItem("dashticheaderbg");
    localStorage.removeItem("dashticbgwhite");
    localStorage.removeItem("dashticmenubg");
    localStorage.removeItem("dashticmenubg");
    checkOptions();
    html.style.removeProperty('--body-bg-rgb');
    html.style.removeProperty("--body-bg-rgb", localStorage.bodyBgRGB);
    html.style.removeProperty("--body-bg-rgb2", localStorage.bodyBgRGB);
    html.style.removeProperty("--light-rgb", localStorage.bodyBgRGB);
    html.style.removeProperty("--form-control-bg", localStorage.bodyBgRGB);
    html.style.removeProperty("--input-border", localStorage.bodyBgRGB);
...
function darkFn() {
    ...
    html.style.removeProperty("--input-border", localStorage.bodyBgRGB);
    updateColors()
    localStorage.setItem("dashticdarktheme", true);
...
function checkOptions() {
    ...
    // light header
    if (localStorage.getItem('dashticHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('dashticHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('dashticHeader') === "gradient") {
    ...
    // transparent header
    if (localStorage.getItem('dashticHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('dashticMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('dashticMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('dashticMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('dashticMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('dashticMenu') === 'transparent') {
        document.querySelector('#switcher-menu-transparent').checked = true;
    }

    //boxed
    if (localStorage.getItem('dashticboxed')) {
        document.querySelector('#switcher-boxed').checked = true;
    }

    //scrollable
    if (localStorage.getItem('dashticheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('dashticmenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('dashticheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('dashticmenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('dashticclassic')) {
...
function updateColors() {
    ...
    if (document.querySelector("#spark11") !== null) {
        widget2();
    }
    if (document.querySelector("#sparkline_bar11") !== null) {
        widget3();
    }
    if (document.querySelector("#widget-CryptoChart") !== null) {
        widget4();
    }
    if (document.querySelector("#widget-CryptoChart11") !== null) {
        widget5();
    }
    if (document.querySelector("#widget-CryptoChart2") !== null) {
        widget6();
    }
    if (document.querySelector("#widget-CryptoChart3") !== null) {
        widget7();
    }
    if (document.querySelector("#shares") !== null) {
        widget8();
    }
}
updateColors()
