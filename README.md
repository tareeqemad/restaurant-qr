...
> آخر تحديث للوثيقة: 4 سبتمبر 2026.
...
يفحص `php artisan app:health` تاريخ مصادر Vue/CSS وملفات npm مقابل `public/build/manifest.json`. إذا كان البناء أقدم من المصدر تظهر حالة **يتطلب إجراء** ويفشل `app:deploy` في التحقق النهائي، حتى لا يبدو النشر ناجحًا بينما الخادم ما زال يعرض واجهة قديمة.
