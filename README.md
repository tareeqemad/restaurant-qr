...
النظام يتم تسليمه للعميل كنسخة ديمو حسب السوق. إذا أعجبه النظام ودفع، أنت تنشئ له ترخيص من لوحة التراخيص الخاصة بك، ثم تبني له باكج production فيه مفتاح الترخيص والـ public key فقط. العميل يفتح `/setup` ويمسح بيانات الديمو ويبدأ ببيانات مطعمه الحقيقية.
...
الـ setup مصمم لتحويل نسخة الديمو إلى نسخة إنتاج حقيقية:
