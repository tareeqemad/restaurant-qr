...
<x-admin.breadcrumb
    title="تسجيل هدر"
    icon="bi-trash3"
    subtitle="سجّل أي كمية خرجت من المخزون بدون بيع — انتهاء صلاحية، تلف، انسكاب، فقد في التحضير، سرقة. النظام يخصم المخزون فوراً ويصنّف الهدر في شاشة تفاصيل الصندوق." />
