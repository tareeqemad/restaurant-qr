...
<title>{{ __('ui.customer_status.session_expired_title') }} · {{ config('restaurant.name') }}</title>
...
<div class="wrap">
    <div class="card">
        <div class="card-inner">
            ...
            <h3 class="title">{{ __('ui.customer_status.session_expired_heading') }}</h3>
            <p class="subtitle">{{ $message ?? __('ui.customer_status.session_expired_default') }}</p>
            <div class="info-box">
                <i class="bi bi-qr-code"></i>
                <div>
                    {{ __('ui.customer_status.scan_qr_again') }}
                </div>
            </div>
        </div>
    </div>
