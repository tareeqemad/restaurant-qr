...
<style scoped>
.inventory-board{--ink:#163a2a;--muted:#6d7d74;--line:#dfe9e3;--green:#176f45;--green-dark:#105a37;--green-soft:#edf8f1;display:grid;min-width:0;gap:16px;padding-block-end:28px;color:var(--ink)}
.inventory-board>*,.inventory-hero__copy,.inventory-hero__actions{min-width:0;max-width:100%;box-sizing:border-box}
.inventory-hero{display:flex;align-items:center;justify-content:space-between;gap:22px;padding:24px;border:1px solid var(--line);border-radius:22px;background:linear-gradient(120deg,#f2faf5 0%,#fff 62%);box-shadow:0 14px 38px rgba(22,58,42,.06)}
.inventory-hero__copy{display:grid;gap:6px}.eyebrow,.section-heading span,.pane-heading span,.queue-card__head span,.accounting-card__head span{color:var(--green);font-size:.72rem;font-weight:850}.inventory-hero h1{margin:0;font-size:clamp(1.55rem,2.8vw,2.25rem);font-weight:950}.inventory-hero p,.pane-heading p,.accounting-card__head p{margin:0;color:var(--muted);font-size:.86rem}.inventory-hero__actions{display:flex;flex-wrap:wrap;gap:8px}.button,.text-action,.row-button,.inline-link{text-decoration:none}.button{display:inline-flex;align-items:center;justify-content:center;gap:8px;min-block-size:44px;padding:10px 15px;border:1px solid transparent;border-radius:12px;font-size:.78rem;font-weight:850}.button--primary{color:#fff;background:var(--green)}.button--primary:hover{color:#fff;background:var(--green-dark)}.button--soft{border-color:#cfe2d6;color:var(--green);background:#fff}
.pulse-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.pulse-card{position:relative;display:grid;grid-template-columns:auto 1fr;grid-template-areas:'icon label' 'icon value' 'icon note';column-gap:11px;min-width:0;padding:17px;border:1px solid var(--line);border-radius:17px;background:#fff}.pulse-card__icon{grid-area:icon;display:grid;width:42px;height:42px;place-items:center;border-radius:12px;color:var(--green);background:var(--green-soft)}.pulse-card__label{grid-area:label;color:var(--muted);font-size:.7rem;font-weight:800}.pulse-card strong{grid-area:value;font-size:1.13rem;font-weight:950}.pulse-card small{grid-area:note;overflow:hidden;color:var(--muted);font-size:.67rem;text-overflow:ellipsis;white-space:nowrap}.pulse-card--danger{border-color:#f1c8c8}.pulse-card--danger .pulse-card__icon{color:#b4232c;background:#fff0f1}.pulse-card--warning{border-color:#ead9af}.pulse-card--warning .pulse-card__icon{color:#94610c;background:#fff8e7}.pulse-card--good .pulse-card__icon{color:#16834f;background:#eaf9f0}.pulse-card--neutral .pulse-card__icon{color:#4d6472;background:#f1f5f7}
.workflow-panel,.work-panel{border:1px solid var(--line);border-radius:20px;background:#fff;box-shadow:0 12px 34px rgba(22,58,42,.045)}.workflow-panel{padding:18px}.section-heading,.pane-heading,.queue-card__head,.accounting-card__head{display:flex;align-items:center;justify-content:space-between;gap:16px}.section-heading h2,.pane-heading h2,.queue-card__head h2,.accounting-card__head h2{margin:2px 0 0;font-size:1.05rem;font-weight:930}.section-heading>small{max-width:360px;color:var(--muted);font-size:.72rem;text-align:end}.workflow-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;margin-block-start:14px}.workflow-card{display:grid;grid-template-columns:auto auto 1fr auto auto;align-items:center;gap:9px;min-width:0;min-height:78px;padding:12px;border:1px solid #e3ebe6;border-radius:15px;color:var(--ink);background:#fbfdfc;text-decoration:none}.workflow-card:hover{border-color:#9ac7aa;background:#f5fbf7}.workflow-card__step{align-self:start;color:#91a198;font-size:.58rem;font-weight:900}.workflow-card__icon{display:grid;width:36px;height:36px;place-items:center;border-radius:10px;color:var(--green);background:var(--green-soft)}.workflow-card__body{display:grid;gap:2px;min-width:0}.workflow-card__body b{font-size:.77rem}.workflow-card__body small{color:var(--muted);font-size:.62rem;line-height:1.5}.workflow-card__metric{display:grid;text-align:end}.workflow-card__metric b{font-size:1rem}.workflow-card__metric small{color:var(--muted);font-size:.58rem;white-space:nowrap}.workflow-card__arrow{font-size:.65rem;color:#9aa8a0}.workflow-card--danger{border-color:#f0cece}.workflow-card--danger .workflow-card__icon{color:#b4232c;background:#fff0f1}.workflow-card--warning .workflow-card__icon{color:#94610c;background:#fff7e4}.workflow-card--success .workflow-card__icon{color:#16834f;background:#eaf9f0}
